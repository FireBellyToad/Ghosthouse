...
import com.faust.ghosthouse.cutscenes.CutsceneManager;
...
public class CutsceneScreen extends AbstractScreen {
    ...
    public CutsceneScreen(GhosthouseGame game, CutsceneEnum cutsceneEnum) {
        super(game);
        ...
        try {
            ...
            Constructor screenConstructor =  ClassReflection.getDeclaredConstructor(cutsceneEnum.getNextScreenClass(), GhosthouseGame.class);
    ...
    private void renderBlackBackground() {
        ...
        background.rect(0, 0, GhosthouseGame.GAME_WIDTH, GhosthouseGame.GAME_HEIGHT);
        background.end();
        game.getBatch().end();
    }
