...
import com.faust.ghosthouse.game.renderer.ParallaxWorldRenderer;
...
public class GameScreen extends AbstractScreen {
    ...
    private ParallaxWorldRenderer worldRenderer;
    ...
    public GameScreen(GhosthouseGame game) {
        super(game);
    ...
    public void show() {
        ...
        worldRenderer = new ParallaxWorldRenderer(game.getBatch(), cameraManager, splashManager);
