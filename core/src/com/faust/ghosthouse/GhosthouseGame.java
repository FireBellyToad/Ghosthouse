...
import com.faust.ghosthouse.screens.impl.LanguageScreen;
import com.faust.ghosthouse.game.music.MusicManager;
import com.faust.ghosthouse.utils.TextLocalizer;

/**
 * Ghosthouse Game class
 *
 * @author Jacopo "Faust" Buttiglieri
 */
public class GhosthouseGame extends Game {
    ...
    public GhosthouseGame(boolean isWebBuild, AbstractSaveFileManager saveFileManager) {
        super();
