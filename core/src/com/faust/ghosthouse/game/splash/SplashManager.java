package com.faust.ghosthouse.game.splash;
...
public class SplashManager implements InputProcessor {
    ...
    public void drawSplash(SpriteBatch batch, float stateTime) {
        ...
        //draw  K keys X
        batch.draw( arrows.getFrame(GameBehavior.IDLE, DirectionEnum.DOWN,stateTime), GhosthouseGame.GAME_WIDTH-24, GhosthouseGame.GAME_HEIGHT -  16);
        batch.draw( arrows.getFrame(GameBehavior.IDLE, DirectionEnum.UP,stateTime), GhosthouseGame.GAME_WIDTH-40, GhosthouseGame.GAME_HEIGHT - 16);
