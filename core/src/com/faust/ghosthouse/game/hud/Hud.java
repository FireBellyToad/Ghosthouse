package com.faust.ghosthouse.game.hud;
...
public class Hud {
    ...
    private final Vector2 meterPosition = new Vector2(2.5f, GhosthouseGame.GAME_HEIGHT - 10);
    private final Vector2 healthKitCountPosition = new Vector2(GhosthouseGame.GAME_WIDTH - 10, GhosthouseGame.GAME_HEIGHT - 4);
    private final Vector2 holyLancePiecesPosition = new Vector2(GhosthouseGame.GAME_WIDTH - 30, GhosthouseGame.GAME_HEIGHT - 4);
    private final Vector2 goldcrossCountPosition = new Vector2(GhosthouseGame.GAME_WIDTH - 50, GhosthouseGame.GAME_HEIGHT - 4);
    ...
    public void drawHud(SpriteBatch batch, PlayerInstance player, OrthographicCamera camera) {
        ...
        backgroundBox.rect(0, GhosthouseGame.GAME_HEIGHT, GhosthouseGame.GAME_WIDTH, -12);
        backgroundBox.end();
        batch.end();
