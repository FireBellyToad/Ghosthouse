package com.faust.ghosthouse.game.textbox.manager;
...
import com.faust.ghosthouse.game.textbox.TextBoxData;
...
public class TextBoxManager {
    ...
    public void renderTextBoxes(final SpriteBatch batch, OrthographicCamera camera) {
        ...
        for (TextBoxData box : textBoxes) {
            ...
            cornerBox.rect(0, 0, GhosthouseGame.GAME_WIDTH, outerBoxHeight);
            cornerBox.end();
            ...
            backgroundBox.rect(2, 2, GhosthouseGame.GAME_WIDTH - 4, innerBoxHeight);
            backgroundBox.end();
            batch.end();
